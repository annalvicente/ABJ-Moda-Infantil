...
$id            = $_POST['id']; 
$nome          = $_POST['nome'];
// MUDANÇA AQUI: Agora recebemos o ID da categoria que vem do <select> do seu formulário
...
// Adicionei o id_vendedor pois agora é obrigatório no seu novo banco
$id_vendedor   = $_POST['id_vendedor'] ?? 1; 

// 2. Lógica para Upload da Imagem 1 (Peça) - Sem alterações
...
// 3. Lógica para Upload da Imagem 2 (No Corpo) - Sem alterações
...
// 4. Decisão: INSERT ou UPDATE (MUDANÇAS NAS QUERIES)
if (empty($id)) {
    // SQL AJUSTADA: id_categoria e id_vendedor inseridos
    ...
    // SQL AJUSTADA: mudamos 'categoria' para 'id_categoria'
